...
> 91 MCP tools | Squad orchestration | Shared memory | Pattern learning
...
- 91 MCP tools for pane management, browser automation, memory, patterns, swarm, trajectories, hooks, skills
