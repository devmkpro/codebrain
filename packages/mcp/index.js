...
function createCodebrainMCPServer(bridge) {
  ...
  // ════════════════════════════════════════════════════════════════════════════
  // MiMo-Code Features — 25 New MCP Tools (always enabled)
  // ════════════════════════════════════════════════════════════════════════════

  // ── 1.1 Session Compaction (3 tools) ─────────────────────────────────────
  ...
  // ── 1.2 Step Classification (2 tools) ────────────────────────────────────
  ...
  // ── 1.3 Text Loop Recovery (2 tools) ─────────────────────────────────────
  ...
  // ── 2.1 Goal / Stop Condition (4 tools) ──────────────────────────────────
  ...
  // ── 3.2-3.3 Checkpoint System (4 tools) ──────────────────────────────────
  ...
  // ── 4.2 Cross-Session History Search (3 tools) ───────────────────────────
  ...
  // ── 2.5 Provider-Specific Prompts (2 tools) ──────────────────────────────
  ...
  console.log(`[MCP] 48 MiMo-Code tools registered (compaction, step-classify, text-loop, goal, snapshot, checkpoint, history, question, multi-edit, provider-prompt, max-mode, compose, plan, LSP)`);
