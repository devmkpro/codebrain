...
function createCodebrainMCPServer(bridge) {
  ...
  // ── Kanban TaskQueue Tools ────────────────────────────────────────────────
  server.tool("mcp__codebrain__task_create", "Create a kanban task.", { title: z.string(), description: z.string().optional(), column: z.string().optional(), priority: z.string().optional(), assigned_to: z.string().optional(), workspace: z.string().optional() }, async (args) => { try { return { content: [{ type: "text", text: JSON.stringify(await bridge.taskCreate(args), null, 2) }] }; } catch (err) { return { content: [{ type: "text", text: `error: ${String(err)}` }], isError: true }; } });
  ...
  server.tool("mcp__codebrain__task_list", "List kanban tasks with optional filters.", { column: z.string().optional(), assigned_to: z.string().optional(), workspace: z.string().optional(), limit: z.number().optional() }, async (args) => { try { return { content: [{ type: "text", text: JSON.stringify(await bridge.taskList(args), null, 2) }] }; } catch (err) { return { content: [{ type: "text", text: `error: ${String(err)}` }], isError: true }; } });
  server.tool("mcp__codebrain__task_complete", "Mark a kanban task as done with optional result.", { id: z.string(), result: z.string().optional() }, async (args) => { try { return { content: [{ type: "text", text: JSON.stringify(await bridge.taskComplete(args), null, 2) }] }; } catch (err) { return { content: [{ type: "text", text: `error: ${String(err)}` }], isError: true }; } });
  server.tool("mcp__codebrain__task_assign", "Assign a kanban task to a pane.", { id: z.string(), paneId: z.string() }, async (args) => { try { return { content: [{ type: "text", text: JSON.stringify(await bridge.taskAssign(args), null, 2) }] }; } catch (err) { return { content: [{ type: "text", text: `error: ${String(err)}` }], isError: true }; } });
