...
export const PROVIDER_REGISTRY: ProviderTemplate[] = [
  ...
  },
  {
    ...
    tokenEnvVar: "OPENAI_API_KEY",
    signupUrl: "https://platform.openai.com/api-keys",
    models: ["gpt-5.6-sol", "gpt-5.6-terra", "gpt-5.6-luna", "gpt-5.5", "gpt-5.5-pro", "gpt-5.4", "gpt-5.4-pro", "gpt-5.4-mini", "gpt-5.4-nano", "gpt-5.3-codex", "gpt-5-mini", "gpt-5-nano", "gpt-5-pro", "gpt-4.1", "gpt-4.1-mini", "gpt-4o-mini", "o3-pro", "o3"],
  ...
  },
  {
    ...
    models: ["grok-4.3", "grok-build-0.1", "grok-4"],
